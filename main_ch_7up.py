...
def find_and_click(image_path, confidence=0.65):
    """Scans for an image within the specified window and clicks it if found."""
    ...
    screen = ImageGrab.grab(bbox)  # Capture only the specified window
    ...
    if max_val >= confidence:
        x, y = max_loc
        w, h = template.shape[::-1]  # Get width and height
        center_x, center_y = x + w // 2 + bbox[0], y + h // 2 + bbox[1]  # Adjust for window position
...
def main():
    always_scan = {
        ...
        "images/q_menu_banner.png": 0.8,
        "images/q_menu_banner1.png": 0.9,
        "images/wm_icon_question.png": 0.9,
    ...
    trigger_images = {
        ...
        "images/auto_set.png": 0.65,
        "images/victory.png": 0.65,
        "images/q_menu_banner.png": 0.65,
        "images/q_menu_banner1.png": 0.65,
